...
int menuStatus = 0; // 0 = hidden, 1 = octave selection, 2 = tune a4, 3 = histogram.
...
void GpioHandler(void *CallbackRef) {
	...
	} else if (data == 2) { // right - NEED TO REMOVE THIS FUNCTION
...
//			repaintMode2(a4Tmp);
//		}
	} else if (data == 4) { // left - NEED TO REMOVE THIS FUNCTION
...
//		}
	...
	} else if (data == 16) { // center - TODO: Need to make a hideMode for the histogram and add to other states...
		printHistogram();
